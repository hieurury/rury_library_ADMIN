        ...
        <NSpace vertical class="p-8 shadow-md rounded-md bg-white dark:bg-slate-600/30">
            ...
            <NGrid :cols="4" x-gap="12" y-gap="12" class="my-4">
                ...
                <NGi :span="2">
                    <NStatistic
                        label="Chức năng"
                        class="relative w-full ring-2 ring-slate-500 bg-gradient-to-r from-purple-600 to-purple-700 dark:from-slate-700/90 dark:to-slate-500/60 shadow-md text-white rounded-md p-4"
                    >
